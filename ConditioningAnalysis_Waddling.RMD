...
Dec13_W_Avg$Freq <- rowMeans(Dec13_W_Avg[,6:7])
dropnotneeded<-c("TotalTimeEl.x","TotalTimeEl.y") #,"TotalTimeEl")
...
```{r}
boxplot(Freq~FieldType,data=WaddleAll,main="Mean Waddling Time Per Field Type",xlab="Field Type",ylab="Mean Waddling Time (seconds)")
stripchart(Freq~FieldType,vertical=T,data=WaddleAll,method="jitter",add=T,pch=20,col='blue')
```
