...
red<-ggplot(Red_W_Test,aes(x=FieldType,y=Freq))+stat_boxplot(geom='errorbar',color="gray1")+geom_boxplot(fill="red2",color="gray1")+scale_y_continuous(name="Mean Waddling Time (seconds)",breaks=seq(0,500,100))+scale_x_discrete((name="Field Type"))+ggtitle("Mean Waddling Time Per Field Type \nNew Brunswick Group")+theme_bw()+theme(plot.title = element_text(hjust = 0.5))+stat_summary(fun.y=mean, geom="point", shape=22, size=3, color="gray1", fill="gray1")

purple<-ggplot(Purple_W_Test,aes(x=FieldType,y=Freq))+stat_boxplot(geom='errorbar',color="gray1")+geom_boxplot(fill="darkorchid3",color="gray1")+scale_y_continuous(name="Mean Waddling Time (seconds)",breaks=seq(0,200,50))+scale_x_discrete((name="Field Type"))+ggtitle("Mean Waddling Time Per Field Type \nBahamas Group")+theme_bw()+theme(plot.title = element_text(hjust = 0.5))+stat_summary(fun.y=mean, geom="point", shape=22, size=3, color="gray1", fill="gray1")
...
ggplot(WaddleAll,aes(x=FieldType,y=Freq))+stat_summary(fun.y="mean",geom="bar",color="cadetblue1",fill="cadetblue1")+stat_summary(fun.y=mean,fun.ymin = function(x) mean(x) - sd(x),fun.ymax = function(x) mean(x) + sd(x),geom="errorbar",color)+theme_bw()+scale_y_continuous(name="Time (seconds)")+scale_x_discrete(name="Field Type")+ggtitle("Mean Food-Seeking Behavior Time per Magnetic Field")
...
red<-ggplot(Red_W_Test,aes(x=FieldType,y=Freq))+stat_summary(fun.y="mean",geom="bar",color="red",fill="red")+stat_summary(fun.y=mean,fun.ymin = function(x) mean(x)-sd(x)/length(x),fun.ymax = function(x) mean(x) + sd(x)/length(x),geom="errorbar",color="black")+theme_bw()+scale_y_continuous(name="Time (seconds)")+scale_x_discrete(name="Field Type")+ggtitle("New Brunswick Group\nMean Food-Seeking Behavior Time\nper Magnetic Field")


purple<-ggplot(Purple_W_Test,aes(x=FieldType,y=Freq))+stat_summary(fun.y="mean",geom="bar",color="purple",fill="purple")+stat_summary(fun.y=mean,fun.ymin = function(x) mean(x)-sd(x)/length(x),fun.ymax = function(x) mean(x) + sd(x)/length(x),geom="errorbar",color="black")+theme_bw()+scale_y_continuous(name="Time (seconds)")+scale_x_discrete(name="Field Type")+ggtitle("Bahamas Group\nMean Food-Seeking Behavior Time\nper Magnetic Field")
